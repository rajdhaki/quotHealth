  ...
  return (
    <section className='relative w-full py-20 lg:py-32 overflow-hidden'>
      ...
      <div className='relative z-10 container mx-auto  '>
        <div className='grid lg:grid-cols-2  items-center bg-linear-to-tr from-[#07C4B8] to-[#36CFA6] px-4 lg:px-16  lg:py-10 rounded-4xl' >

          {/* Left side - Text and CTA */}
          <div className='space-y-2 p'>
            {/* Hashtag */}
            <div style={{ fontFamily: "made-tommy-medium" }} className='text-background/80 text-sm lg:text-base mb-5'>
              #YourHealthPartner
            </div>
            ...
            {/* Download buttons */}
            <div className={`flex flex-col sm:flex-row gap-2 items-center mt-10 ${dmSans.variable}`}>
              <button className='flex items-center gap-3 bg-black text-background pl-3 pr-10 py-1.5 rounded-xl hover:bg-gray-900 transition-colors border border-background'>
              ...
              <div style={{ fontFamily: "made-tommy-medium" }} className='text-background/80 text-lg lg:text-2xl ml-2.5'>
                Coming Soon...
              </div>
            </div>
          </div>
