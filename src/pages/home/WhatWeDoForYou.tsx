 ...
 <section className="min-h-screen py-16 px-4">
      <div className="px-16 mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          ...
          <div className="bg-white rounded-xl p-8 shadow-xl shadow-shadow border border-border transition-shadow">
          ...
          {/* Recover Your Money */}
          <div className="bg-white rounded-xl p-8 shadow-xl shadow-shadow border border-border hover:shadow-xl transition-shadow">
            <div className="flex items-start space-x-4">
        ...
        <div className="text-center ">
          <p className="text-gray600 leading-relaxed px-10 mx-auto text-lg">
